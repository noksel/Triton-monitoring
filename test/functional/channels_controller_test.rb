...
class ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post :create, channel: { chanelName: @channel.chanelName, channelIdn: @channel.channelIdn }
    end
  ...
  test "should update channel" do
    put :update, id: @channel, channel: { chanelName: @channel.chanelName, channelIdn: @channel.channelIdn }
    assert_redirected_to channel_path(assigns(:channel))
  end
